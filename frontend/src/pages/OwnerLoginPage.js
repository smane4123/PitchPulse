        ...
        <>
            ...
            <div className="hero">
                ...
                <div className="content">
                    {/* Your existing owner login form card is placed here */}
                    <div className="login-form-card">
                        ...
                        <form className="login-form" onSubmit={handleLogin}>
                            <div className="form-group">
                                ...
                                <input
                                    type="email" id="owner-email" name="owner-email"
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="password" id="owner-password" name="owner-password"
                            ...
                            <p style={{ marginTop: '20px', textAlign: 'center' }}>
                                Not an owner?{' '}
                                <Link to="/login" style={{ color: '#ff6b3d', fontWeight: 'bold' }}>
                                    Player Login
                                </Link>
                            </p>
                        </form>
